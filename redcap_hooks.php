...
function redcap_email($to, $from, $subject, $message, $cc = NULL, $bcc = NULL, $fromName = NULL, array $attachments = NULL) {
  $hook_event = __FUNCTION__;
  foreach (get_hook_include_files($hook_event) as $script) include $script;
}
...
function redcap_pdf($project_id, array $metadata, array $data, $instrument = NULL, $record = NULL, $event_id = NULL, $instance = 1) {
  $hook_event = __FUNCTION__;
  foreach (get_hook_include_files($hook_event, $project_id) as $script) include $script;
}
